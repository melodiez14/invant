...
class BaseController extends Controller
{
	...
	*/
    ...
    // public function sentTestNotif()
    // {
    //     $user = Auth::user();
    //     $proposal = Proposal::find(9);
    //     $user->newNotification()
    //         ->withUrl(route('proposals.show', $proposal->id))
    //         ->withRemark("Fikri Muhammad Iqbal Has Assigned you to ".$proposal->project_idea." assessment")
    //         ->deliver();
    //     return Redirect::back();
    // }
}
