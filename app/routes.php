...
Route::group(['before' => 'authorize'], function() {
    ...
    Route::get('monthly-report', ['as' => 'dashboard.index', 'uses' => "DashboardController@getSummaryMonthlyReport"]);
...
Route::get('api/staffs',
    array('as'=>'api.staffs', 'uses'=>'StaffController@getDatatable'));
